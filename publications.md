...
* ["Authentication Between Microservices: Is It Really That Hard?"](https://medium.com/google-cloud/authentication-between-microservices-is-it-really-that-hard-b73785510db4?source=friends_link&sk=d7826ed8e076ce9583899f2216b196c8), *Google Cloud Medium Publication*.
...
* ["Multitenant Inference Architecture with SageMaker Endpoints"](https://www.youtube.com/watch?v=BXp1uRHNA9o), Multicloud Engineering Meetup.
...
> As you experiment with Google Cloud, your project tends to get cluttered. This open-source project cleans it up.
...
> My Iris3 open-source project adds labels to resources like VM instances, Pub/Sub topics, and more, making for more detailed cost reports.
...
> Step by step from a research Jupyter Notebook to an AWS distributed machine learning deployment.
...
> Though an emulator is often requested, Google does not offer one for developing with Cloud Tasks, comparable to what it offers for Datastore or Pub/Sub. I created one.
...
* ["Google App Engine Flexible Environment: Beyond the Bounds of PaaS"](https://www.youtube.com/watch?v=QmmzUbX7IEY&t=22s), *Multicloud Engineering*.
> The first ever talk or article dedicated to this new Google PaaS.
...
* ["The Hub and the Edge: Balancing the Responsibilities"](/wp-content/uploads/2014/10/Hub-and-the-Edge.pdf), *Architecture and Governance Magazine*.
...
* ["JRuby on Rails"](https://web.archive.org/web/20230610042818/https://www.javaworld.com/article/2077682/jruby-on-rails--the-power-of-java--the-simplicity-of-ruby-on-rails.amp.html), *JavaWorld*.
...
* ["Collaborative Applications with the Java Shared Data Toolkit"](https://drdobbs.com/184403999#), *Dr. Dobb’s Journal*.
